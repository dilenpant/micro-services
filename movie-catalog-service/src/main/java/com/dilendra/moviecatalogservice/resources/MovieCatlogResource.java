...
import com.dilendra.moviecatalogservice.models.UserRating;
...
//                new Rating("M002", 5), new Rating("M003", 2), new Rating("M004", 4));
        ...
        UserRating ratings = restTemplet.getForObject("http://movie-rating-service/ratingsdata/users/" + userId, UserRating.class);
